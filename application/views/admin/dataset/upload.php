...
<div class="row">
  <div class="col-lg-12">
    ...
    <?php } ?>
    <form role="form" action="<?= base_url() ?>admin/dataset/uploaddokumen" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <input type="text" name="prodi" class="form-control" value="<?= $this->session->userdata('logged_inAdm')['prodi']; ?>" readonly>
        </div>
      </div>
