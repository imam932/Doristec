...
<div class="row">
  <div class="col-lg-12">
    ...
    <?php } ?>
    <form role="form" action="<?= base_url().'admin/dataset/edit/'.$view[0]['id_data']; ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10" style="display:flex;">
          ...
          <a href="<?= base_url().'admin/dataset/editfile/'.$view[0]['id_data']; ?>" class="btn btn-info btn-sm" style="margin-left:30px">
            Edit File
          </a>
        </div>
      </div>
